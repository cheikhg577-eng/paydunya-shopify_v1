...
app.listen(process.env.PORT || 3000, () => { console.log("Serveur démarré"); });const express = require("express");
const axios = require("axios");
const app = express();
app.use(express.json());
app.use(express.urlencoded({ extended: true }));
...
const PAYDUNYA_MASTER_KEY  = "VOTRE_MASTER_KEY";
const PAYDUNYA_PRIVATE_KEY = "VOTRE_PRIVATE_KEY";
const PAYDUNYA_TOKEN       = "VOTRE_TOKEN";
const SERVER_URL           = "https://paydunya-shopifyv1-production.up.railway.app";
const SHOPIFY_STORE        = "bc-shop-9080.myshopify.com";
const SHOPIFY_CLIENT_ID    = "VOTRE_CLIENT_ID";
const SHOPIFY_SECRET       = "VOTRE_CLIENT_SECRET";
